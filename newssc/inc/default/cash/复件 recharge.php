...
;echo '		<div class="bankchoice">
			<label><input value="';echo $bank['id'];echo '" type="radio" name="mBankId" data-bank=\'';echo json_encode($bank);echo '\' /><span style="background:url(/';echo $bank['logo'];echo ');" ></span></label>
		</div>
		';};echo '	</td></tr></table>
	</div>
    ...
    <ul class="backr backc">
      <li><b class="hig">银行类型：</b><img id="bank-type-icon" class="bankimg" src="" title="" style=" margin:0 0 10px 2px;"/></li>
