...
<article class="module width_full">
	<header>
		<h3  class="tabs_involved">充值记录
            <form action="/admin.php/business/rechargeLogList" class="submit_link wz" target="ajax" dataType="html" call="rechargeLogList">
	...
	<div class="tab_content">
    	';$this->display("business/recharge-log-list.php");;echo '    </div>
