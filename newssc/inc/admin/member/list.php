...
<article class="module width_full">
    <header>
    	<h3 class="tabs_involved">用户列表
      	<form class="submit_link wz" action="/admin.php/Member/listUser" dataType="html" target="ajax"  method="get" onajax="userSortBeforeSubmit" call="memberUserList">
        排序：<input name="paixu"  type="hidden" value="uid" />
        ...
        会员名/Q：<input type="text" class="alt_btn" style="width:60px;" value="用户名" name="username"/>&nbsp;&nbsp;
    ...
    <div class="tab_content">
		';$this->display("member/list-user.php") ;echo '    </div>
