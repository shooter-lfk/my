...
$sql="select l.* from {$this->prename}member_session l, {$this->prename}members u where u.uid=l.uid and admin=1 $timeWhere $userWhere order by loginTime desc";
...
;echo '<article class="module width_full">
	...
	<tbody>
	';if($data['data']){
foreach($data['data'] as $var){;echo '		<tr>
