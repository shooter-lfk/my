...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">综合统计
			<form action="/admin.php/countData/betDateSearch"  target="ajax" dataType="html" call="defaultList" class="submit_link wz">
	...
	<div class="tab_content">
    	';$this->display("count/date-list.php");;echo '    </div>
</article>';
?>