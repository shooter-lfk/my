 ...
 * 禁言（管理员操作）
 */
exports.setGad=function(data){
	//console.log('有新的禁言，提交用户名：%s', data.user);
	gag[data.user]=new Date();
	gag[data.user].setTime(gag[data.user].getTime()+config.gagTime*60*1000);
	//console.log(gag);
