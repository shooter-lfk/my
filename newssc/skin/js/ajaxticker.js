...
function ajax_ticker(xmlfile, divId, divClass, delay, fadeornot){
	...
	this.pointer=0
	this.opacitystring=(typeof fadeornot!="")? "width: 100%; filter:progid:DXImageTransform.Microsoft.alpha(opacity=100); opacity: 1" : ""
	if (this.opacitystring!="") this.delay+=500 //add 1/2 sec to account for fade effect, if enabled
		this.opacitysetting=1 //Opacity value when reset. Internal use.
...
ajax_ticker.prototype.fadetransition=function(fadetype, timerid){
	...
	else if (contentdiv.style.opacity!=""){
