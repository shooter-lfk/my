;(function ($) {
	 ...
	 * 传递参数s供onClose捕捉	2010-08-10 add by jcode
	 */
	 ...
	 * onOpen:			(Function:null) The callback function used in place of SimpleModal's open
								当返回false时，将阻止打开事件，jcode修改,2010-5-11
	 * onShow:			(Function:null) The callback function used after the modal dialog has opened
	 * onClose:			(Function:null) The callback function used in place of SimpleModal's close
								当返回false时，将阻止关闭事件，jcode修改,2010-5-11
								接收0到2个参数，第一个参数为modal本身对象，ui-widget ui-widget-content ui-corner-all
								第二个参数为close方法传递过来的值		add by jcode 2010-08-10
	 * speed			打开对话框时的动画效果	add by jcode 2010-08-27
	 */
	$.modal.defaults = {
		appendTo: 'body',
		focus: true,
		...
		dataCss: {padding:'8px',border:'2px solid #353535',background:'#202020'},
		//dataClass: 'ui-widget-content ui-corner-all',
		minHeight: null,
		minWidth: null,
		maxHeight: null,
		maxWidth: null,
	...
	$.modal.impl = {
		...
		open: function (o) {
			...
			if ($.isFunction(s.o.onOpen))
				if(s.o.onOpen.apply(s, [s.d])===false) return false;
			
			// display the iframe
			s.d.iframe && s.d.iframe.show(o);

			// display the remaining elements
			s.d.overlay.show(o);
			s.d.container.show(o);
			s.d.data.show(o);
		...
		close: function (closeStatus) {
			...
			if ($.isFunction(s.o.onClose))
				//if(!s.o.onClose.apply(s, [s.d])) return false;
				if(s.o.onClose([s.d], closeStatus)===false) return false;
